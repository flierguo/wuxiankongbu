/*监控*/
import { _P_P_ATTACK, _P_P_MAGIC, _P_P_RIDING, _P_P_RUNNING, _P_P_WALK, _P_P_PRISON, _P_N_JAIL } from "../基础常量"
...
export function RobotPlugIn(Player: TPlayObject): void {
    ...
    let 人物速度 = 0
    switch (true) {
        case Player.R.人物速度 > 900: 人物速度 = 9; break
        case Player.R.人物速度 > 800 && Player.R.人物速度 <= 900: 人物速度 = 8; break
        case Player.R.人物速度 > 700 && Player.R.人物速度 <= 800: 人物速度 = 7; break
        case Player.R.人物速度 > 600 && Player.R.人物速度 <= 700: 人物速度 = 6; break
        case Player.R.人物速度 > 500 && Player.R.人物速度 <= 600: 人物速度 = 5; break
        case Player.R.人物速度 > 400 && Player.R.人物速度 <= 500: 人物速度 = 4; break
        case Player.R.人物速度 > 300 && Player.R.人物速度 <= 400: 人物速度 = 3; break
        case Player.R.人物速度 > 200 && Player.R.人物速度 <= 300: 人物速度 = 2; break
        case Player.R.人物速度 > 100 && Player.R.人物速度 <= 200: 人物速度 = 1; break
        case Player.R.人物速度 > 0 && Player.R.人物速度 <= 100: 人物速度 = 1; break
    }
    if (Player.V.开启挂机) {
        // switch (人物速度) {
        //     case 0: 攻速 = 17; 魔速 = 13; break
        //     case 1: 攻速 = 18; 魔速 = 14; break
        //     case 2: 攻速 = 19; 魔速 = 15; break
        //     case 3: 攻速 = 21; 魔速 = 15; break
        //     case 4: 攻速 = 21; 魔速 = 16; break
        //     case 5: 攻速 = 23; 魔速 = 18; break
        //     case 6: 攻速 = 26; 魔速 = 19; break
        //     case 7: 攻速 = 28; 魔速 = 20; break
        //     case 8: 攻速 = 31; 魔速 = 22; break
        //     case 9: 攻速 = 35; 魔速 = 28; break
        //     default: 攻速 = 17; 魔速 = 13; break
        // }
        攻速 = 35; 魔速 = 37
    } else {
        // switch (人物速度) {
        //     case 0: 攻速 = 17; 魔速 = 11; break
        //     case 1: 攻速 = 18; 魔速 = 12; break
        //     case 2: 攻速 = 19; 魔速 = 13; break
        //     case 3: 攻速 = 21; 魔速 = 13; break
        //     case 4: 攻速 = 21; 魔速 = 14; break
        //     case 5: 攻速 = 23; 魔速 = 16; break
        //     case 6: 攻速 = 26; 魔速 = 17; break
        //     case 7: 攻速 = 28; 魔速 = 18; break
        //     case 8: 攻速 = 31; 魔速 = 20; break
        //     case 9: 攻速 = 35; 魔速 = 26; break
        //     default: 攻速 = 17; 魔速 = 11; break
        // }
        攻速 = 35; 魔速 = 26
    }
    ...
    // let 人物速度 = 0
    // switch (true) {
    //     case Player.R.人物速度 > 900 && Player.R.人物速度 <= 1000: 人物速度 = 9; break
    //     case Player.R.人物速度 > 800 && Player.R.人物速度 <= 900: 人物速度 = 8; break
    //     case Player.R.人物速度 > 700 && Player.R.人物速度 <= 800: 人物速度 = 7; break
    //     case Player.R.人物速度 > 600 && Player.R.人物速度 <= 700: 人物速度 = 6; break
    //     case Player.R.人物速度 > 500 && Player.R.人物速度 <= 600: 人物速度 = 5; break
    ...
    /*攻击 次数*/
    if (Player.GetPVar(_P_P_ATTACK) > 攻速) {   //攻速
        ...
        // Player.SendMessage('发现（攻击速度）不法行为，再次就要抓监狱啊！', 2);
        // Player.MessageBox('发现(攻击速度)不法行为,石化60秒！！')
        // Debug('玩家[' + Player.Name + ']因"攻击速度"异常被抓进监狱，该玩家被抓[' + String(Player.GetNVar(_P_N_JAIL)) + ']次')
    ...
    if (Player.GetPVar(_P_P_MAGIC) > 魔速) {
    ...
    /*走路 次数*/
    if (Player.GetPVar(_P_P_WALK) > 20) {
        if (Player.GetPVar(_P_P_PRISON) > 2) {
            Player.RandomMove(Prison);
            Player.SetPVar(_P_P_PRISON, 0);
            Player.SetPVar(_P_P_PRISON, Player.GetPVar(_P_P_PRISON) + 1);
