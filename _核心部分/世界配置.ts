...
export const 生物基础值配置 = {
    血量: 200000,   // 血量基础值（小数值，大数值由星级倍数提供）原值 30000
    攻击: 100,    // 攻击基础值
    防御: 40,     // 防御基础值
} as const
...
export const 装备品质配置 = {
    ...
    优秀: { 颜色: 250, 基础倍数: 2, 词条数: { min: 1, max: 4 } },
    稀有: { 颜色: 154, 基础倍数: 3, 词条数: { min: 2, max: 5 } },
    史诗: { 颜色: 254, 基础倍数: 5, 词条数: { min: 2, max: 6 } },
    传说: { 颜色: 251, 基础倍数: 8, 词条数: { min: 3, max: 7 } },
    神话: { 颜色: 244, 基础倍数: 12, 词条数: { min: 4, max: 8 } },
    神器: { 颜色: 249, 基础倍数: 10, 词条数: { min: 1, max: 8 } },
} as const
...
// 难度列表（从难度系数配置自动生成，包含圣耀）
export const 难度列表 = Object.keys(难度系数配置) as (keyof typeof 难度系数配置)[]

// 固定副本难度列表（不含圣耀，圣耀为玩家自建）
export const 固定难度列表: (keyof typeof 难度系数配置)[] = ['简单', '普通', '困难', '精英', '炼狱']
...
export const 固定副本数量 = 5  // 5个固定难度：简单、普通、困难、精英、炼狱（圣耀为玩家自建）
