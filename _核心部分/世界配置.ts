...
// - 固定星级：用于计算星级难度倍数 2^(星级-1)
/**
 * ==================== 地图生物属性参考表 ====================
 * 
 * 计算公式：
 * - 星级难度倍数 = 2^(固定星级-1)，星级1=1倍，星级2=2倍，星级3=4倍...
 * - 血量 = 血量基础 × 生物强度倍数 × 星级难度倍数 × 200 × 随机(0.5~2.0)
 * - 攻击 = 攻击基础 × 生物强度倍数 × 星级难度倍数 × 随机攻击倍数(5~50) × 随机(0.5~2.0)
 * - 防御 = 防御基础 × 生物强度倍数 × 星级难度倍数 × 随机防御倍数(1~20) × 随机(0.5~2.0)
 * 
 * 生物类型基础值：
 * | 类型       | 血量基础 | 攻击基础 | 防御基础 |
 * |------------|----------|----------|----------|
 ...
 * | 稀有怪物   | 2000     | 100      | 50       |
 * | 精英怪物   | 10000    | 500      | 200      |
 * | 首领怪物   | 50000    | 2000     | 1000     |
 * | 大陆BOSS   | 500000   | 10000    | 5000     |
 * | 特殊BOSS   | 50000000 | 20000    | 10000    |
 * 
 * ==================== 各地图基础小怪属性范围 ====================
 * 
 * | 地图名       | 星级 | 强度倍数 | 星级难度 | 血量范围              | 攻击范围          | 防御范围        |
 * |--------------|------|----------|----------|----------------------|-------------------|-----------------|
 * | 浣熊市       | 1    | 1        | 1        | 5000~40000           | 25~1000           | 2.5~200         |
 * | 蜂巢入口     | 2    | 2        | 2        | 20000~160000         | 100~4000          | 10~800          |
 * | 病毒研究室   | 3    | 4        | 4        | 80000~640000         | 400~16000         | 40~3200         |
 * | 生化实验室   | 4    | 8        | 8        | 320000~2560000       | 1600~64000        | 160~12800       |
 * | 激光走廊     | 5    | 16       | 16       | 1280000~10240000     | 6400~256000       | 640~51200       |
 * | 红后控制室   | 6    | 32       | 32       | 5120000~40960000     | 25600~1024000     | 2560~204800     |
 * 
 * 注：实际属性还会受到怪物技能影响（血量/攻击/防御技能倍数）
 */
