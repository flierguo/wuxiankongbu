...
// ==================== TAG词条配置 ====================
const TAG词条配置 = {
    1: { 基础词条: { min: 1, max: 3 }, 魔次几率: 200, 魔次词条: { min: 1, max: 1 } },
    2: { 基础词条: { min: 2, max: 4 }, 魔次几率: 150, 魔次词条: { min: 1, max: 2 } },
    3: { 基础词条: { min: 2, max: 5 }, 魔次几率: 120, 魔次词条: { min: 1, max: 3 } },
    4: { 基础词条: { min: 3, max: 6 }, 魔次几率: 80, 魔次词条: { min: 1, max: 4 } },
    5: { 基础词条: { min: 4, max: 7 }, 魔次几率: 30, 魔次词条: { min: 2, max: 5 } },  // 必获得
    6: { 基础词条: { min: 5, max: 8 }, 魔次几率: 8, 魔次词条: { min: 3, max: 6 } },  // 必获得
    7: { 基础词条: { min: 6, max: 8 }, 魔次几率: 2, 魔次词条: { min: 3, max: 6 } },  // 必获得
} as const
...
export function 装备掉落(Player: TPlayObject, Monster: TActor, UserItem: TUserItem): void {
    ...
    let 是否神器 = false
    let 神器倍数 = 0
    const 神器几率 = Player.R?.神器获得几率 || 0
    if (random(Math.max(100, 2000 - 神器几率)) < 1) {
        是否神器 = true
        神器倍数 = 1 + random(10)
    }
